...
b) {
    ...
    r.extend=r.fn.extend=function() {
        ...
        h<i;
        h++)if(null!=(a=arguments[h]))for(b in a)c=g[b], d=a[b], g!==d&&(j&&d&&(r.isPlainObject(d)||(e=r.isArray(d)))?(e?(e=!1, f=c&&r.isArray(c)?c: []): f=c&&r.isPlainObject(c)?c: {}, g[b]=r.extend(j, f, d)): void 0!==d&&(g[b]=d));
        return g
    }
    ,
    r.extend( {
    ...
    var x=function(a) {
        ...
        Y=/^[^ {
                ...
                e) {
                    ...
                    if(!e&&((b?b.ownerDocument||b: v)!==n&&m(b), b=b||n, p)) {
                        if(11!==w&&(l=Z.exec(a)))if(f=l[1]) {
                            ...
                            else if(s&&(j=s.getElementById(f))&&t(b,
                            j)&&j.id===f)return d.push(j),
                            d
                        }
                        else {
                ...
                m=ga.setDocument=function(a) {
                    ...
                    d.find.TAG=c.getElementsByTagName?function(a,
                    b) {
                    ...
                    ,
                    d.find.CLASS=c.getElementsByClassName&&function(a,
                    b) {
                    ...
                    t=b||Y.test(o.contains)?function(a,
                    b) {
                ...
                ,
                ga.matches=function(a,
                b) {
                    return ga(a, null, null, b)
                }
                ,
                ga.matchesSelector=function(a,
                b) {
                        ...
                        e) {
                            ...
                            i) {
                                ...
                                if(q) {
                                    ...
                                    n=j[0]===w&&j[1],
                                    t=n),
                                    t===!1)while(m=++n&&m&&m[p]||(t=n=0)||o.pop())if((h?m.nodeName.toLowerCase()===r:1===m.nodeType)&&++t&&(s&&(l=m[u]||(m[u] {}),
                                    k=l[m.uniqueID]||(l[m.uniqueID] {}),
                                    k[a]=[w,
                                    t]),
                                    m===b))break;
                ...
                b) {
                    ...
                    return b?h.length:h?ga.error(a):z(a,
                    i).slice(0)
                }
                ;
                function sa(a) {
                ...
                function ya(a) {
                    ...
                    i<f;
                    i++)if(c=d.relative[a[i].type])m=[ta(ua(m),
                    c)];
                    else {
                ...
                return h=ga.compile=function(a,
                b) {
                    var c, d=[], e=[], f=A[a+" "];
                    if(!f) {
                        b||(b=g(a)), c=b.length;
            ...
            c) {
                ...
                this.length=1,
                this):r.isFunction(a)?void 0!==c.ready?c.ready(a):a(r):r.makeArray(a,
                this)
            }
            ;
            G.prototype=r.fn,
            ...
            r.Deferred.exceptionHook=function(b,
            c) {
            ...
            "complete"===d.readyState||"loading"!==d.readyState&&!d.documentElement.doScroll?a.setTimeout(r.ready):(d.addEventListener("DOMContentLoaded",
            R),
            ...
            d) {
                ...
                k=(r.cssNumber[b]||"px"!==j&&+i)&&aa.exec(r.css(a,
                b));
                if(k&&k[3]!==j) {
                    j=j||k[3], c=c||[], k=+i||1;
            ...
            e) {
                ...
                l.textContent="",
                n=0;
                while(f=m[n++])if(d&&r.inArray(f,
                d)>-1)e&&e.push(f);
                else if(j=r.contains(f.ownerDocument,
                f),
                g=ma(l.appendChild(f),
                "script"),
                j&&na(g),
                c) {
                    k=0;
            ...
            r.event {
                global: {}, add: function(a, b, c, d, e) {
                    ...
                    if(q) {
                        ...
                        (m=i[n])||(m=i[n]=[],
                        m.delegateCount=0,
                        l.setup&&l.setup.call(a,
                        d,
                        o,
                        g)!==!1||a.addEventListener&&a.addEventListener(n,
                        g)),
                        l.add&&(l.add.call(a,
                        k),
                        k.handler.guid||(k.handler.guid=c.guid)),
                        e?m.splice(m.delegateCount++,
                        0,
                        k):m.push(k),
                        r.event.global[n]=!0)
                    }
                ...
                e) {
                    ...
                    if(q&&(i=q.events)) {
                        ...
                        else for(n in i)r.event.remove(a,
                        n+b[j],
                        c,
                        d,
                        !0);
                        r.isEmptyObject(i)&&V.remove(a,
                        "handle events")
                    }
                }
                ,
                    ...
                    return S(this, function(a) {
                        ...
                        if("string"==typeof a&&!za.test(a)&&!la[(ja.exec(a)||["", ""])[1].toLowerCase()]) {
                            ...
                            try {
                                for(;
                                c<d;
                                c++)b=this[c]|| {}, 1===b.nodeType&&(r.cleanData(ma(b, !1)), b.innerHTML=a);
                                b=0
                            }
                            catch(e) {}
                        }
            ...
            c) {
                ...
                i||!r.isEmptyObject(n)) {
                    ...
                    i=!1;
                    for(d in n)i||(q?"hidden"in q&&(p=q.hidden):q=V.access(a,
                    "fxshow",
                    {
                        display: j
                    }
            ...
            c) {
                ...
                f<g;
                f++)if(d=hb.prefilters[f].call(j,
                a,
                k,
                j.opts))return r.isFunction(d.stop)&&(r._queueHooks(j.elem,
                j.opts.queue).stop=r.proxy(d.stop,
                d)),
                d;
                return r.map(k,
                eb,
                j),
                r.isFunction(j.opts.start)&&j.opts.start.call(a,
                j),
            ...
            r.fn.extend( {
                ...
                b) {
                    ...
                    return"boolean"==typeof b&&"string"===c?b?this.addClass(a): this.removeClass(a): r.isFunction(a)?this.each(function(c) {
                        ...
                        else void 0!==a&&"boolean"!==c||(b=nb(this),
                        b&&V.set(this,
                        "__className__",
                        b),
            ...
            r.extend(r.event,
            {
                trigger: function(b, c, e, f) {
                    ...
                    if(h=i=e=e||d, 3!==e.nodeType&&8!==e.nodeType&&!pb.test(p+r.event.triggered)&&(p.indexOf(".")>-1&&(q=p.split("."), p=q.shift(), q.sort()), k=p.indexOf(":")<0&&"on"+p, b=b[r.expando]?b: new r.Event(p, "object"==typeof b&&b), b.isTrigger=f?2: 3, b.namespace=q.join("."), b.rnamespace=b.namespace?new RegExp("(^|\\.)"+q.join("\\.(?:.*\\.|)")+"(\\.|$)"): null, b.result=void 0, b.target||(b.target=e), c=null==c?[b]: r.makeArray(c, [b]), n=r.event.special[p]|| {}, f||!n.trigger||n.trigger.apply(e, c)!==!1)) {
                        ...
                        m=(V.get(h,
                        "events")|| {})[b.type]&&V.get(h,
                        "handle"),
                        m&&m.apply(h,
                        c),
                        m=k&&h[k],
                        m&&m.apply&&T(h)&&(b.result=m.apply(h,
                        c),
                        b.result===!1&&b.preventDefault());
                        return b.type=p,
                        f||b.isDefaultPrevented()||n._default&&n._default.apply(o.pop(),
                        c)!==!1||!T(e)||k&&r.isFunction(e[p])&&!r.isWindow(e)&&(i=e[k],
                        i&&(e[k]=null),
                        r.event.triggered=p,
                        e[p](),
            ...
            d) {
                ...
                else if(c||"object"!==r.type(b))d(a,
                b);
                else for(e in b)xb(a+"["+e+"]",
                b[e],
                c,
                d)
            }
