...
t) {
    ...
    b.extend( {
        ...
        n) {
            ...
            if(n) {
                ...
                else for(i in e)if(r=t.apply(e[i],
                n),
                r===!1)break
            }
            else if(a) {
            ...
            else for(i in e)if(r=t.call(e[i],
            i,
            e[i]),
            r===!1)break;
            return e
    ...
    b.extend( {
        ...
        when:function(e) {
            ...
            l=Array(r);
            r>t;
            t++)n[t]&&b.isFunction(n[t].promise)?n[t].promise().done(a(t,
            l,
            n)).fail(o.reject).progress(a(t,
            u,
            s)):--i;
            return i||o.resolveWith(l,
            n),
            o.promise()
        }
    }
    ...
    b.support=function() {
        ...
        b(function() {
            ...
            d.style.width="1px",
            t.reliableMarginRight=!parseFloat((e.getComputedStyle(r,
            null)|| {}).marginRight)),
    ...
    b.extend( {
        cache: {}, expando: "jQuery"+(p+Math.random()).replace(/\D/g, ""), noData: {
    ...
    b.fn.extend( {
        ...
        t) {
            ...
            return b.isFunction(e)?this.each(function(n) {
                ...
                "__className__",
                this.className),
                this.className=this.className||e===!1?"":b._data(this,
                "__className__")||"")
            }
            )
        }
    ...
    b.event= {
        global: {}, add: function(e, n, r, o, a) {
            ...
            if(v) {
                ...
                f,
                !1):e.attachEvent&&e.attachEvent("on"+g,
                f))),
                p.add&&(p.add.call(e,
                d),
        ...
        i) {
            ...
            if(m&&(c=m.events)) {
                ...
                else for(d in c)b.event.remove(e,
                d+t[l],
                n,
                r,
                !0);
        ...
        a) {
            ...
            if(l=f=i=i||o, 3!==i.nodeType&&8!==i.nodeType&&!nt.test(g+b.event.triggered)&&(g.indexOf(".")>=0&&(m=g.split("."), g=m.shift(), m.sort()), u=0>g.indexOf(":")&&"on"+g, n=n[b.expando]?n: new b.Event(g, "object"==typeof n&&n), n.isTrigger=!0, n.namespace=m.join("."), n.namespace_re=n.namespace?RegExp("(^|\\.)"+m.join("\\.(?:.*\\.|)")+"(\\.|$)"): null, n.result=t, n.target||(n.target=i), r=null==r?[n]: b.makeArray(r, [n]), p=b.event.special[g]|| {}, a||!p.trigger||p.trigger.apply(i, r)!==!1)) {
                ...
                s=(b._data(l,
                "events")|| {})[n.type]&&b._data(l,
                "handle"),
                s&&s.apply(l,
                r),
                s=u&&l[u],
                s&&b.acceptData(l)&&s.apply&&s.apply(l,
                r)===!1&&n.preventDefault();
                if(n.type=g,
                !(a||n.isDefaultPrevented()||p._default&&p._default.apply(i.ownerDocument,
    ...
    t) {
        ...
        Y=/^[^ {
            ...
            h=RegExp(h.join("|")),
            g=RegExp(g.join("|")),
            y=rt(f.contains)||f.compareDocumentPosition?function(e,
            t) {
        ...
        ,
        i=st.selectors= {
            cacheLength:50, createPseudo:ot, match:U, find: {}, relative: {
                ">": {
                ...
                i) {
                    ...
                    u) {
                        ...
                        if(m) {
                            ...
                            else while(p=++d&&p&&p[g]||(f=d=0)||h.pop())if((s?p.nodeName.toLowerCase()===y:1===p.nodeType)&&++f&&(v&&((p[x]||(p[x]= {}))[e]=[N,
                            f]),
                            p===t))break;
                            return f-=i,
                            f===r||0===f%r&&f/r>=0
        ...
        t) {
            ...
            return t?s.length:s?st.error(e):E(e,
            u).slice(0)
        }
        function dt(e) {
            ...
            return r&&!r[x]&&(r=yt(r)), i&&!i[x]&&(i=yt(i, o)), ot(function(o, a, s, u) {
                ...
                if(o) {
                    if(i||e) {
                        ...
                        c=y.length;
                        while(c--)(p=y[c])&&(l=i?M.call(o,
                        p):f[c])>-1&&(o[l]=!(a[l]=p))
                    }
                }
                else y=mt(y===a?y.splice(h,
                y.length):y),
                i?i(null,
                a,
                y,
        ...
        function vt(e) {
            ...
            for(;
            o>u;
            u++)if(n=i.relative[e[u].type])f=[ht(gt(f),
            n)];
            else {
        ...
        function Tt() {}i.filters=Tt.prototype=i.pseudos,
        i.setFilters=new Tt,
        c(),
        st.attr=b.attr,
        b.find=st,
    ...
    n) {
        ...
        if("string"==typeof t) {
            ...
            if(ut.test(t))return b.filter(t,
            r,
            !n);
            t=b.filter(t,
            r)
    ...
    b.extend( {
        ...
        r) {
            ...
            s&&f.removeChild(s),
            b.support.appendChecked||b.grep(Ot(d,
            "input"),
            Bt),
            h=0;
            while(o=d[h++])if((!r||-1===b.inArray(o,
            r))&&(a=b.contains(o.ownerDocument,
            o),
            s=Ot(f.appendChild(o),
            "script"),
            a&&Mt(s),
            n)) {
                i=0;
